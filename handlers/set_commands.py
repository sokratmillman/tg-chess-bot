...
from texts import CANCEL_GAME_COMMAND, GET_MY_ID_COMMAND, HELP_COMMAND, START_AI_GAME_COMMAND, START_COMMAND, START_PVP_GAME_COMMAND, LEADERBOARD_COMMAND, MY_HISTORY_COMMAND, MY_STATS_COMMAND
